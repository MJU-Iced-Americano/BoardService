...
public class HomeBannerController {
    ...
    public CommonResult registerBanner(@RequestPart(value = "image", required = false) MultipartFile image) {
        homeBannerService.registerBanner(image);
        return responseService.getSuccessfulResult();
    }
    //배너 삭제
    @DeleteMapping(value = "/delete/{homeBannerIndex}")
    public CommonResult deleteBanner(@PathVariable Long homeBannerIndex) {
    ...
    public CommonResult updateBanner(@PathVariable Long homeBannerIndex, @RequestPart(value = "image", required = true) MultipartFile image) {
